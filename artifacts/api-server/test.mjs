...
console.log("\n🌐  [6] GET /api/autoscan/status");
{
  ...
  ok("queriesCount is a number",        typeof body.queriesCount === "number" && body.queriesCount > 0);
  ok("queries array matches count",     Array.isArray(body.queries) && body.queries.length === body.queriesCount);
